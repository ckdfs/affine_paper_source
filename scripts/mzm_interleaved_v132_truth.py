#!/usr/bin/env python3
"""Pure donor-profile and recipient-correction helpers for MZM v1.3.2."""
...
PROTOCOL_VERSION = "mzm-interleaved-calibration-v1.3.2"
DONOR_PROTOCOL_VERSION = "mzm-interleaved-spur-calibration-v1.3.2"
PILOT_V = 0.04
RECIPIENT_N_AVG = 8
DONOR_N_AVG = 16
...
def donor_half_means(source_sequence_index, window_index, X, Y):
    """Return fixed even/odd eight-window observation means."""
