#!/usr/bin/env python3
"""Pure analysis contracts shared by the MZM interleaved v1.3 tools."""
...
import mzm_interleaved_v13_truth as v13  # noqa: E402
...
def analyze_segment(stage, segment_index, rows, windows, discards,
                    ...
                    read_failures):
    """Replay the acquisition-only contract for one v1.3 segment."""
