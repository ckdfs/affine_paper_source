#!/usr/bin/env python3
"""Pure donor-profile and recipient-correction helpers for MZM v1.3."""
...
PROTOCOL_VERSION = "mzm-interleaved-calibration-v1.3"
DONOR_PROTOCOL_VERSION = "mzm-interleaved-spur-calibration-v1.3"
PILOT_V = 0.09
RECIPIENT_N_AVG = 4
DONOR_N_AVG = 8
