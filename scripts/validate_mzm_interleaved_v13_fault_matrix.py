#!/usr/bin/env python3
"""Read-only pure-contract fault matrix for frozen MZM interleaved v1.3 bundles."""
...
def main():
    ...
    _replay("validate_mzm_interleaved_v13_bundle.py", donor)
    _replay("validate_mzm_interleaved_v13_bundle.py", recipient)
